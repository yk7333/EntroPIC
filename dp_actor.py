...
from core_algos import agg_loss, get_policy_loss_fn, kl_penalty
...
class EntroPICDataParallelPPOActor(DataParallelPPOActor):
    ...
    def __init__(self, config: ActorConfig, actor_module: nn.Module, actor_optimizer: torch.optim.Optimizer = None):
        ...
        self.accumulate_entropy_error = 0.0
        ...
        for _ in range(self.config.ppo_epochs):
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    K_p = self.config.entropy_control_p
                    K_i = self.config.entropy_control_i
                    ...
                    if entropy_coeff != 0 or self.config.target_entropy > 0:
                    ...
                    if self.config.target_entropy >= 0:
                        ...
                        self.accumulate_entropy_error += (entropy_loss_item - self.config.target_entropy) * response_mask.shape[0] / self.config.ppo_mini_batch_size
                    else:
                        control_alpha = 0.0
                    ...
                    micro_batch_metrics.update(
                        {
                            ...
                            "actor/control_alpha": control_alpha.item(),
                        }
                    )
